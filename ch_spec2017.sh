...
if [ "$ACTION" == "copies_intrate" ];then
    ...
    ssh_command_ch "cd /home/amptest/ampere_spec2017/ && sudo rm -rf spec2017/result && sudo ./high_perf.sh"
    start_perf
    ssh_command_ch "cd /home/amptest/ampere_spec2017/ && sudo ./run_spec2017.sh --iterations $ITER --copies $COPIES --$BUILD_OPT --action run $ACTION"
fi
